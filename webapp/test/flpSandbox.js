		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "SAP Workflow",
									"targetURL": "#zwfuolzwfuol-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zwfuolzwfuol-display": {
								"semanticObject": "zwfuolzwfuol",
								"action": "display",
								"description": "SAP Workflow",
								"title": "SAP Workflow",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zwfuol.zwfuol",
									"url": sap.ui.require.toUrl("zwfuol/zwfuol")
								}
							}
						}
					}
